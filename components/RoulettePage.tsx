...
const RoulettePage: React.FC = () => {
    ...
    const handleSpinEnd = (prize: number) => {
        ...
        alert(`You won ${prize}G! Your new balance is ${newBalance}G.`);
    };

    return (
        <div className="container mx-auto p-4 sm:p-6 lg:p-8 text-white animate-fadeIn">
            <h1 className="text-4xl font-bold text-center mb-8 text-brand-gold tracking-wider">Fortune Roulette</h1>
            <div className="flex flex-col items-center">
                <Roulette onSpinEnd={handleSpinEnd} goldBalance={goldBalance} setGoldBalance={updateGoldBalance} />
            </div>
        </div>
    );
};
